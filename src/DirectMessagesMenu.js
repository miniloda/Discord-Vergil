...
const DirectMessagesMenu = () => {
    return(
        <>
<DMMComponent icon = {<FaUserFriends className ="text-gray-500" />} text = "Friends" />
<DMMComponent icon = {nitro} text = "Nitro" />
        </>
    )
}
const DMMComponent = ({icon, text})=>{
    return (<div className = "w-full p-2 h-14  relative">
    <div className = "h-full w-full hover:bg-slate-200 hover:bg-opacity-10 hover:cursor-pointer p-2 rounded-md hover:text-gray-400 ">
