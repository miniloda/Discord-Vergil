...
return(
    <div className = "fixed top-0 left-0 h-screen w-18 m-0 flex flex-col shadow bg-opacity-0 text-white">
        ...
        <SideBarIcon icon = {<FaCompass size = "28" />} text = "Explore public servers" id = "compass-icon" onClick={() => updateActiveElement("compass-icon")}/>
    </div>
)
}
